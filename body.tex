...
Since Kubernetes hides the differences in environments, users can easily deploy a web service on different 
cloud providers or on on-premise data centers, without adjusting the cluster configurations to the new environment. 
...
We will also investigate the feasibility of our proposed load balancer by comparing the performance 
...
by making it run as a part of the web service container cluster itself rather than as part of the Kubernetes cluster infrastructure.  
