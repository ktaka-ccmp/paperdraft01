...
There are two possible solution to make the Kubernetes be able to provide uniform environment even 
...
When a service is created, the master will schedule pods and kubelets on the nodes will create them accodingly.
At the sametime, The masters will send out request to cloud providers API endpoints to set up external load balancers.
