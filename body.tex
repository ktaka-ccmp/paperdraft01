...
into some forms of archives, like the tar.
So whenever one attempts to run a container, those archived file systems
are unpacked and result in exact the same file systems even on totally different datacenters.
...
The Kubernetes container cluster management system is one of the prominet candidates
...
This highlights related work specifically those deal with container cluster migration, 
software loadbalancer containerization or a loadbalancer related tools in the context of container. 

\cite{Verma2015}
\cite{K8sExtLoadBalancer2017}
\cite{K8sFederation2017}
\cite{Zhang2000}
\cite{Pleshakov2016}
\cite{NginxInc2016}
\cite{Prashanth2016}
